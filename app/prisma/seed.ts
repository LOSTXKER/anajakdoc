...
const BOX_TEMPLATES = [
  { title: "ค่าเช่าออฟฟิศ เดือนมกราคม", status: BoxStatus.BOOKED, amount: 35000, hasVat: true, hasWht: true, whtRate: 5, days: 25 },
  { title: "ค่าน้ำมันรถ", status: BoxStatus.READY_TO_BOOK, amount: 2500, hasVat: true, hasWht: false, days: 3 },
  { title: "ค่าอินเทอร์เน็ต TRUE", status: BoxStatus.IN_REVIEW, amount: 1200, hasVat: true, hasWht: false, days: 5 },
  { title: "ค่าจ้างออกแบบโลโก้", status: BoxStatus.NEED_MORE_DOCS, amount: 15000, hasVat: true, hasWht: true, whtRate: 3, days: 7 },
  { title: "ค่าที่ปรึกษาการตลาด", status: BoxStatus.SUBMITTED, amount: 50000, hasVat: true, hasWht: true, whtRate: 3, days: 2 },
  { title: "ค่าโฆษณา Facebook Ads", status: BoxStatus.IN_REVIEW, amount: 8500, hasVat: false, hasWht: false, days: 4 },
  { title: "ค่าอุปกรณ์คอมพิวเตอร์ Dell", status: BoxStatus.BOOKED, amount: 25000, hasVat: true, hasWht: false, days: 15 },
  { title: "ค่าบริการ AWS Cloud", status: BoxStatus.READY_TO_BOOK, amount: 3200, hasVat: false, hasWht: false, days: 1 },
  { title: "ค่าทำความสะอาด", status: BoxStatus.SUBMITTED, amount: 4500, hasVat: true, hasWht: true, whtRate: 1, days: 6 },
  { title: "ค่าซ่อมแอร์ Daikin", status: BoxStatus.IN_REVIEW, amount: 6800, hasVat: true, hasWht: true, whtRate: 3, days: 8 },
  { title: "ค่าจัดส่งสินค้า Kerry", status: BoxStatus.READY_TO_BOOK, amount: 1500, hasVat: true, hasWht: false, days: 2 },
  { title: "ค่าไฟฟ้า MEA", status: BoxStatus.BOOKED, amount: 8900, hasVat: true, hasWht: false, days: 20 },
  { title: "ค่าน้ำประปา MWA", status: BoxStatus.BOOKED, amount: 1200, hasVat: true, hasWht: false, days: 18 },
  { title: "ค่าโทรศัพท์ AIS", status: BoxStatus.IN_REVIEW, amount: 3500, hasVat: true, hasWht: false, days: 3 },
  { title: "ค่าจ้างพัฒนาเว็บไซต์", status: BoxStatus.NEED_MORE_DOCS, amount: 45000, hasVat: true, hasWht: true, whtRate: 3, days: 10 },
];
