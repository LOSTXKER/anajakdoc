...
export const AGING_BUCKET_CONFIG = {
  "0-3": { label: "0-3 วัน", className: "bg-emerald-100 text-emerald-700" },
  "4-7": { label: "4-7 วัน", className: "bg-amber-100 text-amber-700" },
  "8-14": { label: "8-14 วัน", className: "bg-orange-100 text-orange-700" },
  "15+": { label: "15+ วัน", className: "bg-red-100 text-red-700" },
};
