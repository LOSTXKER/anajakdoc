...
const INTEGRATION_TYPES: { value: IntegrationType; label: string; icon: React.ReactNode; description: string }[] = [
  { value: "LINE_NOTIFY", label: "LINE Notify", icon: <MessageCircle className="h-5 w-5 text-green-500" />, description: "ส่งข้อความผ่าน LINE Notify" },
  { value: "LINE_OA", label: "LINE Official Account", icon: <MessageCircle className="h-5 w-5 text-green-600" />, description: "ส่งข้อความผ่าน LINE OA" },
