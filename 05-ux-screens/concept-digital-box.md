...
## ✅ สถานะการดำเนินการ (Checklist Status)

> **แนวคิดใหม่**: แทนที่จะมี status แบบ workflow (Draft → Review → Approve) ใช้ **Checklist** ตามประเภทธุรกรรมแทน

### 🔴 รายจ่าย (EXPENSE) - Checklist

| ขั้นตอน | จำเป็น | เอกสารที่เกี่ยวข้อง | กดติ๊กได้? |
|---------|--------|---------------------|-----------|
| ✅ จ่ายเงินแล้ว | ใช่ | - | กดติ๊ก |
| 📁 มีหลักฐานการจ่าย | ใช่ | สลิปโอนเงิน | อัปโหลด |
| 📋 มีใบกำกับภาษี | ถ้ามี VAT | ใบกำกับภาษี | อัปโหลด |
| 📝 ออก WHT แล้ว | ถ้าหัก | หนังสือหัก ณ ที่จ่าย | อัปโหลด |
| 📤 ส่ง WHT แล้ว | ถ้าหัก | - | กดติ๊ก |

### 🟢 รายรับ (INCOME) - Checklist

| ขั้นตอน | จำเป็น | เอกสารที่เกี่ยวข้อง | กดติ๊กได้? |
|---------|--------|---------------------|-----------|
| 📄 ออกใบแจ้งหนี้แล้ว | ใช่ | ใบแจ้งหนี้ | อัปโหลด |
| 📋 ออกใบกำกับภาษี | ถ้ามี VAT | ใบกำกับภาษี | อัปโหลด |
| 💰 รับเงินแล้ว | ใช่ | - | กดติ๊ก |
| 🧾 มีหลักฐานรับเงิน | ไม่จำเป็น | ใบเสร็จ/สลิป | อัปโหลด |
| 📥 ได้รับ WHT แล้ว | ถ้าถูกหัก | หนังสือหัก ณ ที่จ่าย | อัปโหลด |

### 📊 การคำนวณ % ความสมบูรณ์

```
% ความสมบูรณ์ = (รายการที่เสร็จแล้ว ÷ รายการจำเป็น) × 100

ตัวอย่าง: รายจ่ายมี VAT + หัก WHT
- จำเป็น: 5 รายการ (จ่ายเงิน + สลิป + ใบกำกับ + ออก WHT + ส่ง WHT)
- เสร็จแล้ว: 3 รายการ
- % = (3/5) × 100 = 60%
```
...
| สถานะ | สี | แสดงเมื่อ |
|-------|-----|----------|
| `XX%` | 🟠 ส้ม | ความสมบูรณ์ < 50% |
| `XX%` | 🟡 เหลือง | ความสมบูรณ์ 50-99% |
| `เอกสารครบ` | 🟢 เขียว | ความสมบูรณ์ 100% |
| `Export แล้ว` | 🟣 ม่วง | หลัง Export |
| `บันทึกแล้ว` | 🔵 น้ำเงิน | หลังบันทึกบัญชี |

### 🖥️ UI ตัวอย่าง

```
┌─────────────────────────────────────────────────┐
│ 📋 สถานะการดำเนินการ          ความสมบูรณ์ 60% │
│                                                 │
│ ████████████░░░░░░░░ 60%                        │
│                                                 │
│ [✅] จ่ายเงินแล้ว                                │
...
│     └── 📄 tax_invoice.pdf                      │
│                                                 │
│ [⏳] รอออกหนังสือหัก ณ ที่จ่าย                    │
│     └── [+ อัปโหลด]                             │
│                                                 │
│ [⬜] รอส่งหนังสือหัก ณ ที่จ่าย                    │
│     └── ยังไม่สามารถดำเนินการ (ต้องออกก่อน)       │
└─────────────────────────────────────────────────┘
```
